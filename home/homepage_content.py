...
SERVICES = {
    ...
    "specialties": [
        {"name": "General & Preventive Dentistry", "desc": "General dentistry maintains oral health and prevents disease progression. Patients access 6 core preventive services.", "items": ["General Dentistry", "Check-up and Clean", "Dental X-Rays", "Fluoride Treatment", "Dental Sealants", "Oral Hygiene"]},
        {"name": "Restorative Dentistry", "desc": "Restorative procedures repair damaged teeth and restore oral function. We detail 7 restorative treatments.", "items": ["Dental Fillings", "Dental Crowns", "Dental Bridges", "Inlays and Onlays", "Root Canal Treatment", "Dental Bonding", "Tooth Extraction"]},
        {"name": "Cosmetic Dentistry", "desc": "Cosmetic procedures improve the aesthetic appearance of teeth and gums. We explain 6 aesthetic services, anchored by the Cosmetic Dentistry hub.", "items": ["Cosmetic Dentistry", "Teeth Whitening", "Porcelain Veneers", "Composite Veneers", "Smile Makeover", "Gum Contouring"]},
        {"name": "Orthodontics", "desc": "Orthodontic treatment aligns teeth and corrects jaw discrepancies. We outline 6 orthodontic solutions.", "items": ["Traditional Braces", "Invisalign", "Clear Aligners", "Ceramic Braces", "Lingual Braces", "Early Orthodontic Treatment"]},
        {"name": "Dental Implants", "desc": "Implantology replaces missing teeth with permanent titanium fixtures. We provide guides on 5 implant procedures.", "items": ["Dental Implants", "Single Tooth Implant", "All-on-4 Implants", "Implant-Supported Dentures", "Bone Grafting"]},
        {"name": "Oral Surgery", "desc": "Oral surgery addresses complex extractions and structural jaw issues. We detail 5 surgical treatments anchored by the Oral Surgery hub.", "items": ["Oral Surgery", "Wisdom Teeth Removal", "Corrective Jaw Surgery", "Sleep Apnoea Treatment"]},
        {"name": "Paediatric Dentistry", "desc": "Paediatric specialists treat infants, children, and adolescents. We cover 5 child-specific areas via the Paediatric Dentistry hub.", "items": ["Paediatric Dentistry", "Childrens Dentist", "Fissure Sealants", "Orthodontics for Children", "Dental Care During Pregnancy"]},
        {"name": "Specialist Services", "desc": "Specialist services address highly specific complex dental conditions. We provide 4 dedicated hubs.", "items": ["Endodontics", "Periodontics", "Prosthodontics", "Oral Medicine"]},
    ],
}
...
CONDITIONS = {
    ...
    "items": [
        "Tooth Decay", "Gum Disease", "Gingivitis", "Periodontitis", "Tooth Abscess",
        "Pulpitis", "Sensitive Teeth", "Bruxism (Teeth Grinding)", "TMJ Disorders", "Dry Mouth",
        "Halitosis (Bad Breath)", "Canker Sores", "Oral Thrush", "Oral Cancer", "Leukoplakia",
        "Geographic Tongue", "Dental Fluorosis", "Enamel Erosion", "Malocclusion", "Impacted Teeth",
    ],
}
    ...
    "categories": [
        {
            ...
            "items": ["Cost of Dental Implants", "Cost of Root Canal", "Cost of Dental Crown", "Cost of Wisdom Teeth Removal", "Cost of Invisalign", "Cost of Teeth Whitening", "Cost of Veneers", "Cost of Dental Check-Up"],
        },
        {
            ...
            "items": ["Best Dental Insurance", "HCF Dental Cover", "Bupa Dental Cover", "Medibank Dental Cover", "NIB Dental Cover"],
        },
        {
            ...
            "items": ["Public Dental Services State-by-State", "Medicare Dental Cover", "Child Dental Benefits Schedule", "Veterans Dental"],
        },
        {
            ...
            "items": ["Dental Payment Plans", "Dental Afterpay", "Buy Now Pay Later Dental", "Low-Income Dental Assistance"],
        },
    ],
}
